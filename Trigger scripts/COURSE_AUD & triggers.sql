...
CREATE DEFINER = kasia@LOCALHOST TRIGGER COURSES_CREATE
    AFTER INSERT
    ON courses
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = kasia@LOCALHOST TRIGGER COURSES_DELETE
    AFTER DELETE
    ON courses
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = kasia@LOCALHOST TRIGGER COURSES_UPDATE
    AFTER UPDATE
    ON courses
    FOR EACH ROW
BEGIN
