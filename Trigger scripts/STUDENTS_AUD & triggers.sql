...
CREATE DEFINER = admin@LOCALHOST TRIGGER STUDENTS_DELETE
    AFTER DELETE
    ON students
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = admin@LOCALHOST TRIGGER STUDENTS_CREATE
    AFTER INSERT
    ON students
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = admin@LOCALHOST TRIGGER STUDENTS_UPDATE
    AFTER UPDATE
    ON students
    FOR EACH ROW
BEGIN
