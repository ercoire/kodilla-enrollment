...
CREATE DEFINER = ADMIN@LOCALHOST TRIGGER TEACHERS_DELETE
    AFTER DELETE
    ON TEACHERS
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = ADMIN@LOCALHOST TRIGGER TEACHERS_CREATE
    AFTER INSERT
    ON TEACHERS
    FOR EACH ROW
BEGIN
...
CREATE DEFINER = ADMIN@LOCALHOST TRIGGER TEACHERS_UPDATE
    AFTER UPDATE
    ON TEACHERS
    FOR EACH ROW
BEGIN
